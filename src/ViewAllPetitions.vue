...
<v-container>
<h1>Petitions</h1>
<ol><li v-for="item in allPetitions"> ID: {{ item.petitionId }} title: {{ item.title }} country: {{ item.category }} on date: {{ item.authorName }}signatures: {{ item.signatureCount }}</li></ol>
